...
COPY . .
WORKDIR "/src/WebDeCuong.Api"
RUN dotnet build "WebDeCuong.Api.csproj" -c Release -o /app/build

FROM build AS publish
RUN dotnet publish "WebDeCuong.Api.csproj" -c Release -o /app/publish /p:UseAppHost=false
